...
public class BlastFurnace extends BlockContainer
{
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.BLAST_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.BLAST_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModBlocks.BLAST_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.BLAST_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
	...
	{
		return new ItemStack(ModBlocks.BLAST_FURNACE_OFF);
	}
